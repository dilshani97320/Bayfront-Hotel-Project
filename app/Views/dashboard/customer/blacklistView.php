        ...
        <div class="tablecard">
            <div class="card">
                ...
                <div class="cardheader">
                    <div class="options">
                        <h4>Customer Blacklist View 
                        <span>
                            <a href="<?php url("customer/blacklist"); ?>" class="addnew"><i class="material-icons">reply_all</i></a>
                            <a href="<?php url("customer/blacklistDetails/".$customer['customer_id']); ?>" class="refresh"><i class="material-icons">loop</i></a>    
                        </span>
                        </h4>  
                    </div>
