                    ...
                    <div class="options">
                        <h4>Current Rooms
                            <span>
                                ...
                                <a href="<?php url("editweb/createNew"); ?>" class="addnew"><i
                                        class="material-icons">add_circle</i></a>
                                <?php endif; ?>
                                <a href="<?php url("editweb/index"); ?>" class="refresh"><i
                    ...
                    <div class="tablebody">
                        <table>
                            ...
                            <tbody>
                                ...
                                <?php if($_SESSION['user_level'] == "Owner"): ?>
                                <td><a href="<?php url('editweb/selectChange/'.$row['room_number']);?>" class="edit"><i
                                            class="material-icons">edit</i></a></td>
                                <td><a href="<?php url('editweb/delete/'.$row['room_id'].'/'.$row['room_number']);?>"
                                        onclick="return confirm('Are you sure to delete this record?');"
                                        class="delete"><i class="material-icons">delete</i></a></td>
