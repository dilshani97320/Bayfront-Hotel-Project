...
<div class="wrapper">
   ...
   <div class="content">
       <div class="tablecard">
           <div class="card">
               <div class="cardheader">
                   ...
                   <p class="textfortabel">Reservations Details View Following Table</p>
               </div>
               <div class="cardbody">
    ...
    <h3>Enter the date to get report upto now</h2>
        <form method="post" action="<?php url('report/eview');?>">
